            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="user-type" class="col-md-4 col-form-label text-md-right">{{ __('Quyền Truy Cập') }}</label>

                            <div class="col-md-6">
                                <select id="user-type" class="form-control @error('phone') is-invalid @enderror" name="user-type">
